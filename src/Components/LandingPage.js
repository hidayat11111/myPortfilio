...
// {emial code}
  ...
  return (
    <div className="bg-black pb-6 lg:pb-3 ">
     ...
     <nav className="navbar">
      ...
      <div className="w-full bg-black">
        <BackgroundLines className="flex items-center bg-black justify-center w-full h-svh flex-col gap-3 px-4">
          <CardContainer className="relative w-[65%] lg:w-[45%] h-auto mx-auto">
            <CardBody className=" dark:bg-black dark:border-white/[0.2] border-black/[0.1] rounded-full p-2 h-auto group/card transition-shadow duration-300 ease-in-out dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1]">
              <CardItem translateZ="100" className="w-full ">
                <img
                  src={myProfile}
                  className="w-full h-auto object-cover border-2 border-gray-600 py-3.5 rounded-full"
                  alt="Profile"
                />
              </CardItem>
            </CardBody>
          ...
          <h2 className="pb-2 bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-3xl md:text-4xl lg:text-6xl font-sans font-bold tracking-tight relative z-20">
          ...
          <div className="flex flex-row items-center gap-5 z-10 mt-3">
            <Link to="/LandingPage" className="text-white">
              <button
                className=" bg-white text-[#292F36] flex flex-wrap gap-1 items-center font-sans text-sm px-5 py-2.5 rounded-2xl cursor-pointer"
        ...
        <div className="lg:w-[75%] flex justify-center lg:justify-normal flex-row flex-wrap  lg:flex-nowrap gap-5 lg:gap-0">
          ...
          <div className=" w-[90%] flex flex-col-reverse lg:flex-col items-center justify-evenly gap-3">
            ...
            <div className=" w-[87%] lg:w-[90%] ">
              <p className="font-sans text-neutral-500 font-light tracking-wider text-sm text-center lg:text-left  ">
      ...
      <div className="lg:h-svh flex flex-col justify-evenly items-center pt-5 lg:pt-0 ">
        ...
        <div className="w-[85%] xl:w-[75%] mx-auto flex flex-row flex-wrap justify-between gap-3 mt-10 xl:mt-0">
          <div
            className="border-2 border-gray-600 rounded-xl xl:w-[50%] px-3.5 py-5 flex flex-col gap-3"
            data-aos="fade-up"
          >
          ...
          <div className="xl:w-[35%] h-auto" data-aos="fade-up">
            <WobbleCard containerClassName="h-auto w-full py-5 px-3.5">
              <div className="flex flex-row items-center gap-1">
                <img className="w-10" src={star} alt="error" />{" "}
                <p className="font-sans font-bold text-neutral-800 text-lg">
      ...
      <div className="flex justify-center opacity-70 mt-10">
        <svg
          width="75%"
          height="100"
      ...
      id="projects"
       ...
       className="lg:h-svh h-auto flex flex-col items-center justify-evenly w-full gap-3">
        ...
        <div className="flex flex-col items-center pt-10 xl:pt-0 ">
          ...
          <img className=" lg:w-44" src={slider} alt="error" />
          {/* <img className="w-32 lg:w-3" src={slider} alt="error" /> */}
          <p className="text-neutral-100 font-sans text-base mt-1 text-center lg:text-start">
        ...
        >
          <div className="relative h-auto overflow-hidden rounded-xl border-2 border-gray-600 mt-3">
            ...
            >
              <div className="flex flex-col gap-6 justify-center items-center h-full py-10">
                <div className="flex flex-row justify-between w-[70%]">
                  {" "}
                  <p className="text-white">Ingredient Insight</p>{" "}
                  <Link
            ...
            >
              <div className="flex flex-col gap-6 justify-center items-center h-full py-10">
                <div className="flex flex-row justify-between w-[70%]">
                  <p className="text-white">Hospital Management</p>
                  <Link
            ...
            >
              <div className="flex flex-col gap-6 justify-center items-center h-full py-10">
                <div className="flex flex-row justify-between  w-[70%]">
                  <p className="text-white">AI Room Decorator</p>{" "}
                  <Link
      ...
      id="contact"
       ...
       className="lg:h-svh flex flex-col items-center justify-evenly w-full lg:gap-3 gap-14">
        ...
        <div className="flex flex-col items-center xl:pt-0 ">
          ...
          <p className="text-neutral-100 font-sans text-base mt-1">
            I am currently available for work
          </p>
        </div>

        <img className="w-60" src={almond} alt="erroe" />
        <form className=" w-[85%] lg:w-[60%] bg-black flex flex-col gap-10 items-center ">
          <div className="w-full flex flex-wrap justify-between gap-6">
            <div className="flex flex-col gap-2.5 w-[45%]">
              ...
              <input
                id="name"
                className="bg-black text-white text-sm border-b-2 border-[#12F7D6] focus:outline-none focus:border-[#0FE7C6] pb-1 "
      ...
      <div className="w-full flex flex-col items-center mt-8 mb-3 ">
        <hr className="w-full bg-white opacity-40 " />
      ...
      >
        <p className="text-white font-sans opacity-75">
